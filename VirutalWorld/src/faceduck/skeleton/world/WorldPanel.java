...
/**
 * This class represents an element in the GUI for rabbit world. This panel draws the actual world,
 * and also controls running the rabbit world appropriately.
 */
...
public class WorldPanel extends JPanel implements Runnable {
  ...
  /**
   * This method steps the world once and then updates the UI. This method can be safely called from
   * a separate thread.
   */
  public boolean step() {
   ...
   *
   * @param num The number of steps to run
   */
